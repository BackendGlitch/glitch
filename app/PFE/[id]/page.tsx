  ...
  if (!project) {
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-white font-heading">Loading...</div>
      </div>
    )
  }

  const accent = { border: "border-[#7C3AED]/30", bg: "bg-[#7C3AED]/5", text: "text-[#7C3AED]" }
  const difficultyColors: Record<string, string> = {
    High: "text-red-400 border-red-400/20 bg-red-400/5",
    "Medium-High": "text-amber-400 border-amber-400/20 bg-amber-400/5",
    Medium: "text-green-400 border-green-400/20 bg-green-400/5",
  }
      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4 md:px-8 max-w-5xl">
          ...
          <div className="mb-12">
            <button
              onClick={() => router.back()}
              className="inline-flex items-center gap-2 mb-6 px-4 py-2 border border-white/5 bg-white/[0.02] text-[#A0A0A0] hover:text-white hover:border-[#7C3AED]/30 transition-all font-heading text-sm rounded-lg"
            >
            ...
            <div className="mb-8">
              <div className={`inline-block mb-4 px-4 py-2 border ${accent.border} ${accent.bg} text-xs ${accent.text} rounded-lg font-mono`}>
                {project.id}
              </div>
              <h1 className={`text-4xl md:text-6xl font-heading ${accent.text} mb-4 leading-tight`}>
                {project.title}
              </h1>
              <div className={`inline-block px-3 py-1 border ${difficultyColors[project.difficulty]} text-xs mb-6 rounded-lg font-mono`}>
                {project.difficulty}
              </div>
              <p className="text-xl leading-relaxed max-w-3xl text-[#A0A0A0]">
                {project.description}
              </p>
            </div>
          </div>
          ...
          <div className="space-y-10 text-[#A0A0A0]">
            {/* Project Context */}
            {project.context && (
              <section className={`p-8 md:p-10 border ${accent.border} ${accent.bg} bg-white/[0.02] rounded-xl`}>
                <h2 className={`text-3xl font-heading ${accent.text} mb-6 flex items-center gap-3`}>
                  <FileText className="h-7 w-7" />
                  PROJECT CONTEXT
                </h2>
                <div className="prose prose-lg max-w-none">
                  <div className="text-lg md:text-xl leading-relaxed space-y-4 text-[#A0A0A0]">
              ...
              <>
                <section className={`p-8 md:p-10 border ${accent.border} ${accent.bg} bg-white/[0.02] rounded-xl`}>
                  ...
                  <div className="space-y-6">
                    <div>
                      <h3 className={`text-xl font-heading ${accent.text} mb-4`}>Overview</h3>
                      {project.id === "PFE001" ? (
                        <p className="text-lg md:text-xl leading-relaxed text-[#A0A0A0] mb-4">
                    ...
                    <div>
                      <h3 className={`text-xl font-heading ${accent.text} mb-4`}>Key Features</h3>
                      {project.id === "PFE001" ? (
                        <ul className="space-y-3">
                          <li className="flex items-start gap-4 text-lg md:text-xl leading-relaxed">
                            <CheckCircle2 className={`h-6 w-6 ${accent.text} mt-1 flex-shrink-0`} />
                    ...
                    <div>
                      <h3 className={`text-xl font-heading ${accent.text} mb-4`}>Technical Implementation</h3>
                      {project.id === "PFE001" ? (
                        <p className="text-lg md:text-xl leading-relaxed text-[#A0A0A0] mb-4">
                ...
                <section className={`p-8 md:p-10 border ${accent.border} ${accent.bg} bg-white/[0.02] rounded-xl`}>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <h3 className={`text-xl font-heading ${accent.text} mb-4`}>Core Responsibilities</h3>
                      {project.id === "PFE001" ? (
                        <ul className="space-y-3">
                          <li className="flex items-start gap-4 text-lg md:text-xl leading-relaxed">
                            <CheckCircle2 className={`h-6 w-6 ${accent.text} mt-1 flex-shrink-0`} />
                    ...
                    <div>
                      <h3 className={`text-xl font-heading ${accent.text} mb-4`}>Architecture Components</h3>
                      <div className="space-y-4">
                        <div>
                          <h4 className={`text-lg font-heading ${accent.text} mb-2`}>REST API</h4>
                        ...
                        <div>
                          <h4 className={`text-lg font-heading ${accent.text} mb-2`}>WebSocket Hub</h4>
                          <p className="text-lg leading-relaxed text-[#A0A0A0]">
                        ...
                        <div>
                          <h4 className={`text-lg font-heading ${accent.text} mb-2`}>Job Scheduler</h4>
                          <p className="text-lg leading-relaxed text-[#A0A0A0]">
                        ...
                        <div>
                          <h4 className={`text-lg font-heading ${accent.text} mb-2`}>Pricing Engine</h4>
                          <p className="text-lg leading-relaxed text-[#A0A0A0]">
                    ...
                    <div>
                      <h3 className={`text-xl font-heading ${accent.text} mb-4`}>Scalability & Performance</h3>
                      {project.id === "PFE001" ? (
                        <p className="text-lg md:text-xl leading-relaxed text-[#A0A0A0] mb-4">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <section className={`p-8 border ${accent.border} ${accent.bg} bg-white/[0.02] rounded-xl`}>
                <h2 className={`text-2xl font-heading ${accent.text} mb-6 flex items-center gap-3`}>
                ...
                <div className="flex flex-wrap gap-3">
                  {project.skills.map((skill) => (
                    <span
                      key={skill}
                      className={`px-4 py-2 text-base font-heading border-2 ${accent.border} ${accent.bg} ${accent.text}`}
                    >
                      {skill}
                    </span>
                  ))}
              ...
              <section className={`p-8 border ${accent.border} ${accent.bg} bg-white/[0.02] rounded-xl`}>
                ...
                <div className="flex flex-wrap gap-3">
                  {project.stack.map((tech) => (
                    <span
                      key={tech}
                      className="px-4 py-2 text-base font-heading border-2 border-zinc-700 bg-zinc-800 text-[#A0A0A0]"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <div className="space-y-3">
                  {project.orderLifecycle.map((state, idx) => (
                    <div key={idx} className="flex items-center gap-4 text-lg md:text-xl">
                      <div className={`w-8 h-8 flex items-center justify-center border-2 ${accent.border} ${accent.bg} ${accent.text} font-heading text-sm flex-shrink-0`}>
                        {idx + 1}
                      </div>
            ...
            {project.educationalValue && project.educationalValue.length > 0 && (
              <section className={`p-8 md:p-10 border ${accent.border} ${accent.bg} bg-white/[0.02] rounded-xl`}>
                ...
                <p className="text-lg md:text-xl mb-6 leading-relaxed text-[#A0A0A0]">
            ...
            {/* Timeline */}
            <section className={`p-8 border ${accent.border} ${accent.bg} bg-white/[0.02] rounded-xl`}>
              <h2 className={`text-2xl font-heading ${accent.text} mb-4 flex items-center gap-3`}>
            ...
            {project.diagram && project.diagram.mermaid && (
              <section className={`p-8 md:p-10 border ${accent.border} ${accent.bg} bg-white/[0.02] rounded-xl`}>
                <h2 className={`text-3xl font-heading ${accent.text} mb-4`}>
                  {project.diagram.title}
                </h2>
                <p className="mb-8 text-lg md:text-xl leading-relaxed text-[#A0A0A0]">
                  {project.diagram.description}
                </p>
                <div className={`p-6 border-2 ${accent.border} bg-black rounded-xl overflow-auto`}>
